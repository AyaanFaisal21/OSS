...
(Ignored?) https://github.com/vercel/ai/pull/15753 | tool call failure not working as intended for specific model due to legacy image URL format

(Approved, not merged see thread) https://github.com/supabase/edge-runtime/pull/706 | CLS Cert store bug caused by a cert replacing a store instead of appending itself to it
